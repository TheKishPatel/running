...
argument-hint: [session notes / splits / HR]
---

Analyze a completed training session for the Sub-20 5K campaign.

Session input: $ARGUMENTS
Session data is provided inline — splits, HR, and notes pasted into the conversation
(or describe the watch screenshot). If no input is given, ask for the session data.
