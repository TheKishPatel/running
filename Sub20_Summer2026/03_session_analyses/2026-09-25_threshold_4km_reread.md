...
**4 km continuous @ 4:19/km (17:17), 166 avg, 273 W. The last 3 km ran 4:18/km @ 169, 276 W.**
**Same pace shape as 2 Jul, the campaign's best tempo, with the last two km 5 and 12 bpm lower.**

## Splits (auto km — no recoveries in the data)

| km | Segment | Time | HR | Power |
|---|---|---|---|---|
| 1 | Warm-up | 6:16 | 137 | 195 W |
| 2 | Threshold 1 | 4:24 | 156 | 266 W |
| 3 | Threshold 2 | 4:20 | 171 | 275 W |
| 4 | Threshold 3 | 4:19 | 170 | 274 W |
| 5 | Threshold 4 | **4:14** | 167 | 278 W |
| 6 | Cool-down | 6:28 | 146 | 179 W |
| +0.01 | — | 0:04 | 138 | 176 W |

Zones: Z1 02:47 / Z2 03:21 / Z3 07:48 / Z4 09:51 / Z5 00:00. **The zones sum to 23:47 against
~30:05 elapsed.** The table undercounts again (as on 6 Sep), so the splits are the record.
Post-workout 135 → 106 → 99, taken after a 1 km cool-down and not comparable to no-cool-down traces.
...
| Session | km-by-km pace | km-by-km HR | Power | Main-set avg |
|---|---|---|---|---|
...
- **vs 6 Aug:** **4 sec/km faster at 3 bpm lower**, same power band.
- **Last 3 km 4:17.7/km** — the first time in this campaign threshold has read faster than 4:20.
  It sits inside the 4:15–4:18 threshold target the half block set and never reached.
...
3. **1 km warm-up.** km2 (4:24 @ 156) absorbed it as planned. It was the slowest km, and it is
   excluded from the scored reps.

## Scoring (set 22 Sep, in advance)

| Criterion | Target | Actual | |
|---|---|---|---|
| Pace, reps 2–4 | 4:20 or faster | **4:17.7** | ✅ |
| HR avg, reps 2–4 | ≤172 | **169.3** (170.5 excl. km5) | ✅ |
| Rep 4 HR | ≤176 | **167** | ✅ |

**🟢 Top row: threshold intact or moved → W3 progresses at 4:17.**
...
- **Sub-20:30 and a PB: realistic, and firmer after today. Sub-20:00: still a stretch, but less
  of one.** Three quality weeks remain to move 4:18 further.
- **Pacing discipline held without terrain doing the work.** Opened slowest, progressed, one
  2-second breach. **On the hard end, that is the best execution since 2 Jul.**
