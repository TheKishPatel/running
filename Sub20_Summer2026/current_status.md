...
**✅ Mon 10 Aug — 14 km COMPLETE, LONGEST RUN OF THE CAMPAIGN. 80:05, 5:43/km, HR peak 150.** Avg HR 138, **max 155**, Z1–2 98.9%, 0:54 above the cap, post-run 137→102→101. **GATE PASSED** — the cap was breached by 54 s, the same magnitude as 2 Aug (0:59, max 152), i.e. ordinary end-of-run drift. **48 h soreness check due Wed 12 Aug** closes it: three readings — Tue on waking (before Barry's, uncontaminated), Wed on waking, and the first 2 km of Wednesday's easy run. **Calf/achilles soreness still present at 48 h → repeat 14 km rather than progress to 16.** Quad soreness on Wednesday is Barry's, not the run. km1 6:37 = the most conservative opener yet. **But the creep repeated: 5:44 → 5:33 → 5:30 across the run, and that — not the distance — is what pushed HR to the cap.** Full read: `03_session_analyses/2026-08-10_long_14km_gate.md`.
